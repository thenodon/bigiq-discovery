...
from bigiq_discovery.file_service_discovery import file_service_discovery
from bigiq_discovery.http_service_discovery import http_service_discovery


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='BigIQ (F5) service discovery')
